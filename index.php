<?php
//phpinfo();
//echo '<img src="http://ec2-18-208-213-145.compute-1.amazonaws.com/home/ubuntu/server/images/starwars.png">';
//echo '';
//echo basename('stang');
...
foreach($images as $image){
  ...
  echo '<div onClick="getID('.$i.')"><img src="'.$image.'" id="'.$i.'" alt="'.basename($image).'" style="width:100%;max-width:300px" class="hover-shadow cursor"></div>';
